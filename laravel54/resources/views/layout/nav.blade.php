    ...
    <div class="container">
        <form action="/posts/search" method="GET">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li>
                    <input name="query" type="text" value="@if(!empty($query)){{$query}}@endif" class="form-control"
                           style="margin-top:10px" placeholder="搜索词">
                </li>
                <li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <div>
                        {{--<img src="{{$posts['user']->avatar}}" alt="" class="img-rounded" style="border-radius:500px; height: 30px">--}}
                        ...
                        <li><a href="/user/{{Auth::user()->id}}">我的主页</a>
                </li>
